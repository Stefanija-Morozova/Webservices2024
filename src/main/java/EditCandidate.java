			         ...
			         public void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
			           	String driver = "com.mysql.jdbc.Driver";
			        		...
			        		try { //takes the inserted values/parameters of the form, turns them into a set of values and inserted into the sql statement
			             		PreparedStatement statement1 = connection2.prepareStatement("UPDATE candidates SET LAST_NAME = ?, FIRST_NAME = ?, PARTY = ?, MUNICIPALITY = ?, AGE = ?, DESCRIPTION = ? WHERE CANDIDATE_ID = ?;");
			   		         ...
			   		         System.out.println("Could not Update Candidate");
			   		     }
